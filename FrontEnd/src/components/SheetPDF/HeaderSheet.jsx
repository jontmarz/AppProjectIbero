    ...
    <>
        <Grid container spacing={4} sx={{ mt: 4, width: '1100px', mx: 'auto' }}>
            ...
            <Grid item xs={3} sx={{ border:1, pl: "0 !important", pt: "0 !important" }}>
                <Typography variant="h6" component="h2" sx={{ mt: 1, textAlign: 'center', mb: 1, px: 3, fontWeight:700 }}>Fecha de entrega a Comité Focal: {dataApp.deadLine ? dataApp.deadLine : 'S/D'}</Typography>
            </Grid>
        </Grid>
    </>
  )
